...
describe('Vector3', () => {
  ...
  describe('equals', () => {
    ...
    it('uses epsilon for comparison', () => {
      const a: Vector3 = [1, 2, 3];
      const b: Vector3 = [1.000001, 2.000001, 3.000001];
  ...
  describe('min/max', () => {
    it('computes component-wise minimum', () => {
      const a: Vector3 = [1, 5, 3];
      const b: Vector3 = [2, 3, 4];
