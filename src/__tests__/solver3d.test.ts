 ...
 */
function createLShapedRoom(): Polygon3D[] {
  const height = 3;
...
describe('L-shaped room occlusion', () => {
  it('rejects direct paths that cross inner walls', () => {
    ...
    const source: Vector3 = [2, 2, 1.5];   // In lower arm at x=2, y=2
    const listener: Vector3 = [7, 7, 1.5]; // In upper arm at x=7, y=7
  ...
  it('finds direct paths that do not cross inner walls', () => {
    ...
    const source: Vector3 = [7, 7, 1.5];  // In upper arm
    const listener: Vector3 = [8, 8, 1.5]; // Also in upper arm
  ...
  it('rejects reflection paths that cross inner walls', () => {
    ...
    const source: Vector3 = [2, 2, 1.5];   // In lower arm
    const listener: Vector3 = [7, 7, 1.5]; // In upper arm
