...
import type { Line2D } from '../geometry';
...
describe('Geometry utilities', () => {
  ...
  describe('Mirror operations', () => {
    it('mirrors point across horizontal wall', () => {
      // Wall on x-axis
      const wallP1: Point = [0, 0];
      const wallP2: Point = [100, 0];

      const point: Point = [50, 10];
    ...
    it('mirrors point across vertical wall', () => {
      // Wall on y-axis
      const wallP1: Point = [0, 0];
      const wallP2: Point = [0, 100];

      const point: Point = [10, 50];
      const mirrored = mirrorPointAcrossWall(point, wallP1, wallP2);
  ...
  describe('Beam boundary operations', () => {
    it('constructs beam boundary lines', () => {
      ...
      const virtualSource: Point = [50, -50];
      const windowP1: Point = [0, 0];
      const windowP2: Point = [100, 0];
    ...
    it('correctly identifies point outside beam', () => {
      ...
      const outsidePoint: Point = [-50, 25];
