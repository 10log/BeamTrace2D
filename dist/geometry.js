 ...
 */
export function isPointBehindLine(point, line) {
    return signedDistanceToLine(point, line) < 0;
}
/**
 * Check if a point is in front of or on a line
 */
export function isPointInFrontOfLine(point, line) {
    return signedDistanceToLine(point, line) >= 0;
}
/**
 ...
 */
export function mirrorPointAcrossWall(point, wallP1, wallP2) {
 ...
 */
export function mirrorLineAcrossWall(line, wallP1, wallP2) {
 ...
 */
export function constructBeamBoundaryLines(virtualSource, windowP1, windowP2) {
 ...
 */
export function isPointInBeam(point, boundaries) {
 ...
 */
export function findBeamViolation(point, boundaries) {
